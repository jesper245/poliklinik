...
<div class="register-box">
  ...
  <div class="card">
    ...
    <div class="card-header">
      <h3><p class="login-box-msg">Riwayat Daftar Poli</p></h3>
    </div>
    <!-- catatan bila tidak ada data akan tampil "Tidak ada data" -->
            <table class="table">
                <thead>
                    <tr>
                        <th>No.</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Routing DB</td>
                        <td>
                            <a href="detail_riwayat_daftar_poli.php" class="btn btn-info btn-sm"><i class="fas fa-info-circle"></i> Detail</a>
                        </td>
                    </tr>
                </tbody>
            </table>
